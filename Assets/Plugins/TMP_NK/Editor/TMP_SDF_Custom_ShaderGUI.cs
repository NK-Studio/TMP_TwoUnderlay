...
{
    public class TMP_SDF_Custom_ShaderGUI : TMP_BaseShaderGUI
    {
        static ShaderFeature s_OutlineFeature, s_UnderlayFeature, s_Underlay2Feature ,s_BevelFeature, s_GlowFeature, s_MaskFeature;

        static bool s_Face = true, s_Outline = true, s_Outline2, s_Underlay, s_Underlay2 ,s_Lighting, s_Glow, s_Bevel, s_Light, s_Bump, s_Env;
        ...
        static TMP_SDF_Custom_ShaderGUI()
        {
        ...
        protected override void DoGUI()
        {
            ...
            s_Outline = m_Material.HasProperty(CustomShaderUtilities.ID_OutlineTex) ? BeginPanel("Outline", s_Outline) : BeginPanel("Outline", s_OutlineFeature, s_Outline);
            if (s_Outline)
            {
                DoOutlinePanel();
            }
            ...
            if (m_Material.HasProperty(CustomShaderUtilities.ID_Outline2Color))
            {
            ...
            if (m_Material.HasProperty(CustomShaderUtilities.ID_UnderlayColor))
            {
                s_Underlay = BeginPanel("Underlay 01", s_UnderlayFeature, s_Underlay);
                if (s_Underlay)
                {
                    DoUnderlayPanel(1);
                }
            ...
            if (m_Material.HasProperty(CustomShaderUtilities.ID_Underlay2Color))
            {
            ...
            if (m_Material.HasProperty(CustomShaderUtilities.ID_GlowColor))
            {
        ...
        void DoFacePanel()
        {
            ...
            if (m_Material.HasProperty(CustomShaderUtilities.ID_FaceTex))
            {
            ...
            if (m_Material.HasProperty(CustomShaderUtilities.ID_FaceDilate))
            {
                DoSlider("_FaceDilate", "Dilate");
                if (m_Material.HasProperty(CustomShaderUtilities.ID_Shininess))
                {
        ...
        void DoOutlinePanel()
        {
            ...
            if (m_Material.HasProperty(CustomShaderUtilities.ID_OutlineTex))
            {
        ...
        void DoUnderlayPanel(int index)
        {
            EditorGUI.indentLevel += 1;
            ...
            else if (index == 2)
            {
                ...
                DoSlider("_Underlay2OffsetX", "Offset X");
                DoSlider("_Underlay2OffsetY", "Offset Y");
                DoSlider("_Underlay2Dilate", "Dilate");
                DoSlider("_Underlay2Softness", "Softness");
            }
        ...
        void DoDebugPanel()
        {
            ...
            if (m_Material.HasProperty(CustomShaderUtilities.ID_Sharpness))
            ...
            if (m_Material.HasProperty(CustomShaderUtilities.ID_MaskCoord))
            {
                EditorGUILayout.Space();
            ...
            else if (m_Material.HasProperty(CustomShaderUtilities.ID_MaskSoftnessX))
            {
                EditorGUILayout.Space();
            ...
            if (m_Material.HasProperty(CustomShaderUtilities.ID_StencilID))
            {
                EditorGUILayout.Space();
            ...
            if (m_Material.HasProperty(CustomShaderUtilities.ShaderTag_CullMode))
            {
                EditorGUILayout.Space();
