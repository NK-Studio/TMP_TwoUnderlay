...
namespace TMPro
{
    public static class CustomShaderUtilities
    {
        // Shader Property IDs
        ...
        /// Property ID for the _UnderlayOffset shader property used by URP and HDRP shaders
        /// </summary>
        public static int ID_Underlay2Offset;
        ...
        /// Property ID for the _UnderlayIsoPerimeter shader property used by URP and HDRP shaders
        /// </summary>
        public static int ID_Underlay2IsoPerimeter;
        ...
        public static void GetShaderPropertyIDs()
        {
            if (isInitialized == false)
            {
                ...
                ID_Underlay2Offset = Shader.PropertyToID("_Underlay2Offset");
                ID_Underlay2IsoPerimeter = Shader.PropertyToID("_Underlay2IsoPerimeter");
